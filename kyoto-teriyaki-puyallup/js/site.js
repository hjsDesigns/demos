...
/* ------------------------------------------------------------
   HOURS — Restaurantji (page updated Sep 5, 2026) lists Monday
   through Saturday 11 AM – 7:30 PM and Sunday closed; Google's
   profile agrees on the Monday 11 AM open and the Sunday close.
   0 = Sunday … 6 = Saturday. Decimal 24h (19.5 = 7:30 PM).
   ------------------------------------------------------------ */
var HOURS = {
  tz: 'America/Los_Angeles',
  days: {
    0: null,                          // Sunday    closed
    1: [11, 19.5],                    // Monday    11:00 AM – 7:30 PM
    2: [11, 19.5],                    // Tuesday
    3: [11, 19.5],                    // Wednesday
    4: [11, 19.5],                    // Thursday
    5: [11, 19.5],                    // Friday
...
/* No holiday rules are published anywhere for this shop — nothing is
   asserted here. The hours band says to call ahead on a holiday. */
